...
async function seedDemoUser() {
    const now = new Date();
    const currentSalaryDate = (0, date_fns_1.subDays)(now, 21);
    const previousSalaryDate = (0, date_fns_1.subMonths)(currentSalaryDate, 1);
    const olderSalaryDate = (0, date_fns_1.subMonths)(currentSalaryDate, 2);
    const currentMonth = calendarDate((0, date_fns_1.startOfMonth)(now));
    const previousMonth = calendarDate((0, date_fns_1.startOfMonth)((0, date_fns_1.subMonths)(now, 1)));
        ...
        data: [
            {
                ...
                amount: 320,
                date: (0, date_fns_1.addDays)(currentSalaryDate, 8),
                source: 'FREELANCE',
            ...
            },
            {
                userId: user.id,
                amount: 150,
                date: (0, date_fns_1.addDays)(previousSalaryDate, 5),
                source: 'BONUS',
            ...
            },
            {
                userId: user.id,
                amount: 42,
                date: (0, date_fns_1.addDays)(olderSalaryDate, 12),
                source: 'INVESTMENT',
                description: 'Investment dividend',
            },
        ],
    });
    const [rentRecurring, streamingRecurring, internetRecurring, gymRecurring] = await Promise.all([
        prisma.recurringPayment.create({
            data: {
                ...
                frequency: 'MONTHLY',
                intervalCount: 1,
                nextDueDate: (0, date_fns_1.addDays)(now, 9),
                active: true,
            },
        }),
        prisma.recurringPayment.create({
            data: {
                ...
                frequency: 'MONTHLY',
                intervalCount: 1,
                nextDueDate: (0, date_fns_1.addDays)(now, 4),
                active: true,
            },
        }),
        prisma.recurringPayment.create({
            data: {
                ...
                frequency: 'MONTHLY',
                intervalCount: 1,
                nextDueDate: (0, date_fns_1.addDays)(now, 6),
                active: true,
            },
        }),
        prisma.recurringPayment.create({
            data: {
                ...
                frequency: 'MONTHLY',
                intervalCount: 1,
                nextDueDate: (0, date_fns_1.addDays)(now, 12),
                active: true,
            },
        }),
    ]);
    const phoneInstallment = await prisma.installment.create({
        data: {
            ...
            startDate: (0, date_fns_1.subMonths)(now, 5),
    ...
    const expenses = [
        {
            userId: user.id,
            amount: 550,
            date: (0, date_fns_1.addDays)(currentSalaryDate, 1),
            categoryId: categoryId('Rent'),
            paymentMethod: 'BANK_TRANSFER',
        ...
        },
        {
            userId: user.id,
            amount: 138.4,
            date: (0, date_fns_1.addDays)(currentSalaryDate, 2),
        ...
        },
        {
            userId: user.id,
            amount: 76.25,
            date: (0, date_fns_1.addDays)(currentSalaryDate, 12),
            categoryId: categoryId('Grocery'),
            paymentMethod: 'DEBIT_CARD',
        ...
        },
        {
            userId: user.id,
            amount: 18.5,
            date: (0, date_fns_1.addDays)(currentSalaryDate, 3),
        ...
        },
        {
            userId: user.id,
            amount: 27,
            date: (0, date_fns_1.addDays)(currentSalaryDate, 9),
            categoryId: categoryId('Food'),
            paymentMethod: 'CREDIT_CARD',
        ...
        },
        {
            userId: user.id,
            amount: 12.75,
            date: (0, date_fns_1.addDays)(currentSalaryDate, 15),
            categoryId: categoryId('Food'),
            paymentMethod: 'CASH',
        ...
        },
        {
            userId: user.id,
            amount: 51,
            date: (0, date_fns_1.addDays)(currentSalaryDate, 5),
        ...
        },
        {
            userId: user.id,
            amount: 46,
            date: (0, date_fns_1.addDays)(currentSalaryDate, 17),
            categoryId: categoryId('Fuel'),
            paymentMethod: 'CREDIT_CARD',
            description: 'Fuel refill',
            salaryIncomeId: currentSalary.id,
        },
        {
            userId: user.id,
            amount: 68,
            date: (0, date_fns_1.addDays)(currentSalaryDate, 7),
            categoryId: categoryId('Bills'),
            paymentMethod: 'BANK_TRANSFER',
        ...
        },
        {
            userId: user.id,
            amount: 75,
            date: (0, date_fns_1.addDays)(currentSalaryDate, 10),
        ...
        },
        {
            userId: user.id,
            amount: 44,
            date: (0, date_fns_1.addDays)(currentSalaryDate, 13),
        ...
        },
        {
            userId: user.id,
            amount: 11.99,
            date: (0, date_fns_1.addDays)(currentSalaryDate, 14),
            categoryId: categoryId('Subscriptions'),
            paymentMethod: 'CREDIT_CARD',
        ...
        },
        {
            userId: user.id,
            amount: 29,
            date: (0, date_fns_1.addDays)(currentSalaryDate, 16),
            categoryId: categoryId('Healthcare'),
            paymentMethod: 'DEBIT_CARD',
        ...
        },
        {
            userId: user.id,
            amount: 550,
            date: (0, date_fns_1.addDays)(previousSalaryDate, 1),
            categoryId: categoryId('Rent'),
            paymentMethod: 'BANK_TRANSFER',
            description: 'Apartment rent',
        ...
        },
        {
            userId: user.id,
            amount: 192.7,
            date: (0, date_fns_1.addDays)(previousSalaryDate, 3),
            categoryId: categoryId('Grocery'),
            paymentMethod: 'DEBIT_CARD',
        ...
        },
        {
            userId: user.id,
            amount: 97,
            date: (0, date_fns_1.addDays)(previousSalaryDate, 8),
            categoryId: categoryId('Food'),
            paymentMethod: 'CASH',
        ...
        },
        {
            userId: user.id,
            amount: 103,
            date: (0, date_fns_1.addDays)(previousSalaryDate, 11),
            categoryId: categoryId('Fuel'),
            paymentMethod: 'CREDIT_CARD',
        ...
        },
        {
            userId: user.id,
            amount: 85,
            date: (0, date_fns_1.addDays)(previousSalaryDate, 15),
            categoryId: categoryId('Shopping'),
            paymentMethod: 'CREDIT_CARD',
        ...
        },
        {
            userId: user.id,
            amount: 75,
            date: (0, date_fns_1.addDays)(previousSalaryDate, 17),
            categoryId: categoryId('Shopping'),
            paymentMethod: 'CREDIT_CARD',
            description: 'Smartphone installment',
            salaryIncomeId: previousSalary.id,
        ...
        },
        {
            userId: user.id,
            amount: 550,
            date: (0, date_fns_1.addDays)(olderSalaryDate, 1),
            categoryId: categoryId('Rent'),
            paymentMethod: 'BANK_TRANSFER',
            description: 'Apartment rent',
            salaryIncomeId: olderSalary.id,
        ...
        },
        {
            userId: user.id,
            amount: 220,
            date: (0, date_fns_1.addDays)(olderSalaryDate, 4),
            categoryId: categoryId('Grocery'),
            paymentMethod: 'DEBIT_CARD',
            description: 'Groceries',
            salaryIncomeId: olderSalary.id,
        ...
        },
        {
            userId: user.id,
            amount: 140,
            date: (0, date_fns_1.addDays)(olderSalaryDate, 16),
        ...
        },
        {
            userId: user.id,
            amount: 34,
            date: (0, date_fns_1.subDays)(now, 2),
    ...
    const carLoan = await prisma.debt.create({
        data: {
            ...
            dueDate: (0, date_fns_1.addDays)((0, date_fns_1.subMonths)(now, -24), 10),
            ...
            payments: {
                create: Array.from({ length: 10 }, (_, index) => ({
                    ...
                    date: (0, date_fns_1.addDays)((0, date_fns_1.subMonths)(now, 10 - index), 4),
                    isExtra: index === 2,
    ...
    await prisma.debt.create({
        data: {
            ...
            dueDate: (0, date_fns_1.addDays)(now, 20),
            counterparty: 'Demo Bank',
            payments: {
                create: [
                    { amount: 120, date: (0, date_fns_1.subMonths)(now, 2), isExtra: false },
                    { amount: 180, date: (0, date_fns_1.subMonths)(now, 1), isExtra: true },
                ],
            },
        },
    });
    const receivable = await prisma.debt.create({
        data: {
            ...
            interestRate: 0,
            monthlyPayment: 100,
            startDate: (0, date_fns_1.subMonths)(now, 4),
            dueDate: (0, date_fns_1.addDays)(now, 45),
            counterparty: 'Ahmad',
    ...
    const repaymentIncome = await prisma.income.create({
        data: {
            userId: user.id,
            amount: 250,
            date: (0, date_fns_1.subDays)(now, 6),
            source: 'OTHER',
        ...
        data: [
            {
                recurringPaymentId: streamingRecurring.id,
                userId: user.id,
                date: (0, date_fns_1.addDays)(now, 4),
                amount: 11.99,
                status: 'PENDING',
            },
            {
                recurringPaymentId: internetRecurring.id,
                userId: user.id,
                date: (0, date_fns_1.subDays)(now, 24),
                amount: 32,
                status: 'APPROVED',
            },
            {
                recurringPaymentId: gymRecurring.id,
                userId: user.id,
                date: (0, date_fns_1.subDays)(now, 18),
                amount: 29,
                status: 'REMOVED',
            },
        ],
        ...
        data: {
            ...
            drives: {
                create: [
                    {
                        type: 'PERSONAL',
                        date: calendarDate((0, date_fns_1.subDays)(now, 2)),
                        distanceKm: 42,
                    ...
                    {
                        type: 'COMMUTE',
                        date: calendarDate((0, date_fns_1.subDays)(now, 3)),
                        distanceKm: 34,
                    ...
                    },
                    {
                        ...
                        date: calendarDate((0, date_fns_1.subDays)(now, 10)),
                        distanceKm: 8,
                ...
                create: [
                    {
                        ...
                        records: {
                            create: {
                                date: calendarDate((0, date_fns_1.subMonths)(now, 4)),
                                odometerKm: 82000,
        ...
        data: {
            ...
            messages: {
                create: [
                    ...
                    {
                        role: 'assistant',
                        content: 'Your current salary cycle is healthy, but rent and groceries are your largest categories. Keep an eye on discretionary food and shopping spending before the next salary.',
                        proposals: [],
                    },
                ],
            },
